...
import { ArrowRight, Sparkles, Building2, Shield, Zap, Clock } from "lucide-react"

export default function CTA() {
  const stats = [
    { value: "500+", label: "Financial Institutions", icon: Building2 },
    { value: "99.99%", label: "API Uptime", icon: Shield },
    { value: "50M+", label: "Transactions/Month", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                PCI DSS Compliant & SOC 2 Certified
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join leading financial institutions who trust OpenFlow for secure, 
                compliant open banking APIs. Start your digital transformation today.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by top-tier banks and fintech innovators
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                30 days free with full API documentation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go live in weeks with our integration specialists
              </p>
            </div>
          </div>
        </div>
